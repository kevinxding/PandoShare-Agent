...
function acceptanceSteps() {
  return [
    ...
    npmStep('scheduled-smoke', 'scheduled:smoke'),
    ...
    npmStep('tui-shell-smoke', 'tui:shell-smoke'),
    npmStep('tui-adapter-smoke', 'tui:adapter-smoke'),
    npmStep('tui-launch-smoke', 'tui:launch-smoke'),
    npmStep('tui-thread-smoke', 'tui:thread-smoke'),
    npmStep('tui-approval-smoke', 'tui:approval-smoke'),
