...
function formatHelp(): string {
  return [
    ...
    '',
    'Usage:',
    '  pando                    Open the Pando TUI',
    '  pando tui [--smoke]     Open the OpenTUI renderer explicitly',
    '  pando repl              Open the legacy text REPL',
    '  pando "prompt"        Run one prompt directly',
    '  pando exec "prompt"   Run one non-interactive prompt',
    '  pando doctor [--json]',
    ...
    '  --provider <id>    Override model.provider for pando/tui/prompt/exec/repl.',
    '  --model <name>     Override model.name for pando/tui/prompt/exec/repl.',
    ...
    '  --plain           Use the legacy ASCII TUI shell for debugging.',
